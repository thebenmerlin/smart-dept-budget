...
INSERT INTO users (department_id, name, email, password_hash, role) VALUES
  ...
  (1, 'Dr. Rajesh Kumar', 'hod@rscoe.edu.in', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.HQgZU0j5MqVqPi', 'hod'),
  (1, 'Prof. Sneha Patil', 'staff@rscoe. edu.in', '$2a$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/X4.HQgZU0j5MqVqPi', 'staff');